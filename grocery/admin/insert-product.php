...
<!--                                    <div class="controls">-->
<!--                                        <input type="text"    name="productShippingcharge"  placeholder="Enter Product Shipping Charge" class="span8 tip">-->
<!--                                    </div>-->
<!--                                </div>-->
