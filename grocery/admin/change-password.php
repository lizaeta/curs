...
<head>
	...
	<title>Адмін| Change Password</title>
...
{
alert("Підтвердження паролю пустий!");
...
<label class="control-label" for="basicinput">Поточний пароль</label>
<div class="controls">
...
<div class="control-group">
<label class="control-label" for="basicinput">Новий пароль</label>
<div class="controls">
...
<div class="control-group">
<label class="control-label" for="basicinput">Підтвердження паролю</label>
<div class="controls">
